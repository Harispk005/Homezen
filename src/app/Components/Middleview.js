            ...
            >
                {slides.map((slide, index) => (
                    <SwiperSlide key={index} className="relative">
                        ...
                        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-6 min-h-full">
                            <div className="flex flex-col justify-center items-center flex-grow">
                                <h1 className={`text-[30px] md:text-[42px] text-white font-bold md:mt-[100px] ${audiowide.className}`}>
                                    {slide.title}
                                </h1>
                            ...
                            <div className="flex justify-center items-center gap-4 mb-20">
                                ...
                                <button className={`bg-white text-black px-4 py-2 rounded-[10px] hover:bg-black hover:text-white transition duration-500 w-[130px] h-[40px] ${facultyGlyphic.className}`} onClick={() => scrollToSection('contact')}>
                                    Contact Us
                                </button>
                            </div>
                        </div>
